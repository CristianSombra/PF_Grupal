...
function Carrusel() {
  ...
  return (
    ...
    <Carousel>
      <Carousel.Item>
        <img src={Banner2} alt="Slide 1" className="d-block w-75 h-50 mx-auto" />
        <Carousel.Caption>
          <h3>Primer foto</h3>
      ...
      <Carousel.Item>
        <img src={Banner3} alt="Slide 2" className="d-block w-75 h-50 mx-auto" />
        <Carousel.Caption>
          <h3>Segunda foto</h3>
      ...
      <Carousel.Item>
        <img src={Banner4} alt="Slide 3" className="d-block w-75 h-50 mx-auto" />
        <Carousel.Caption>
          <h3>Tercer foto</h3>
