...
function Wishlist(product) {
  ...
  const handleRemoveFromWishlist = (product) => {
    dispatch(removeFromWishlist(product)); // Despacha la acción para eliminar de la wishlist
    // Otras lógicas o mensajes relacionados con la eliminación...
  };

  if (!wishlist || wishlist.length === 0) {
    return <div>No hay items en tu lista de favoritos</div>;
  }
